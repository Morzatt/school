...
<div class="size-full flex items-center justify-between gap-2">
    <div class="w-1/4 h-full flex flex-col items-center justify-start bg-base-200/50 border border-base-content/30 rounded-md">
    ...
    <div class="w-3/4 h-full bg-base-200/50 rounded-md border border-base-content/30 p-6">
